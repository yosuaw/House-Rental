<%-- 
    Document   : Rental
    Created on : Jun 2, 2021, 4:28:23 PM
    Author     : ACER
--%>
...
<html>
    ...
    <body>
                ...
                <div class="nav-header">
                    ...
                    <nav id="fh5co-menu-wrap" role="navigation">
                        <ul class="sf-menu" id="fh5co-primary-menu">
                            ...
                            <li class="active"><a href="ReservasiPage.jsp">Reservasi</a></li>
        ...
        <% String username = request.getAttribute("nama").toString();
            request.setAttribute("rumah", request.getParameter("namaRumah")); %>
        ...
        <%
            try {
                ...
                if (request.getAttribute("rumah") == null) {
                    request.setAttribute("rumah", "");
                }
                ...
                if (hasil.contains("sukses") && !request.getParameter("nama_rumah").equals("Rumah X Puri Mas")) {
                    String[] splitted = hasil.split(":");
                    request.setAttribute("result", "Reservasi berhasil! Harga total = Rp. " + splitted[1]);
                } else if (hasil.contains("gagal") && !request.getParameter("nama_rumah").equals("Rumah X Puri Mas")) {
                            ...
                            <div class="row">
                                <div class="col-xxs-12 col-xs-12">
                                    <div class="input-field">
                                        <label for="from">Nama Rumah:</label>
                                        <input type="text" placeholder="Rumah X Puri Mas" name="nama_rumah" value="<%=request.getAttribute("rumah")%>" required/>
                                    </div>
                                </div>
                                <div class="col-xxs-12 col-xs-12">
                                    <div class="input-field">
                                ...
                                <div class="col-xxs-12 col-xs-12 text-center">
                                    <p><input type="submit" name="btnReservasi" value="Reservasi" class="btn btn-primary btn-lg" href="#"></p>
                                </div>
                                <div>
